...
-- Database Update - Only Missing Tables and Data
-- =============================================
...
-- 3. UPDATE USERS TABLE (add missing columns if not exist)
-- =============================================
...
SET @sql = (SELECT IF(
  ...
  'ALTER TABLE `users` ADD COLUMN `phone` varchar(255) NULL AFTER `full_name`',
...
-- NOTES:
-- 1. This SQL uses IF NOT EXISTS and INSERT IGNORE to avoid errors
