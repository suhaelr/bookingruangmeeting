...
@section('title', 'Profil - Sistem Pemesanan Ruang Meeting')
            ...
            <div class="lg:col-span-1">
                <div class="border border-gray-200 rounded-2xl p-6">
                    <div class="text-center">
                        ...
                        <span class="inline-block px-3 py-1 bg-indigo-500/20 text-indigo-700 text-xs rounded-full mt-2">
                            {{ ucfirst($user['role']) }}
                        </span>
                    </div>
                </div>
                        ...
                        <div>
                            ...
                            <div class="relative">
                                <select id="unit_kerja" name="unit_kerja"
                                    ...
                                    <option value="SEKRETARIAT UTAMA" {{ old('unit_kerja', $user['unit_kerja'] ?? '') == 'SEKRETARIAT UTAMA' ? 'selected' : '' }}>SEKRETARIAT UTAMA</option>
                                    <option value="DEPUTI BIDANG PENYEDIAAN DAN PENYALURAN" {{ old('unit_kerja', $user['unit_kerja'] ?? '') == 'DEPUTI BIDANG PENYEDIAAN DAN PENYALURAN' ? 'selected' : '' }}>DEPUTI BIDANG PENYEDIAAN DAN PENYALURAN</option>
                                    <option value="DEPUTI BIDANG PROMOSI DAN KERJA SAMA" {{ old('unit_kerja', $user['unit_kerja'] ?? '') == 'DEPUTI BIDANG PROMOSI DAN KERJA SAMA' ? 'selected' : '' }}>DEPUTI BIDANG PROMOSI DAN KERJA SAMA</option>
                                    <option value="DEPUTI BIDANG SISTEM DAN TATA KELOLA" {{ old('unit_kerja', $user['unit_kerja'] ?? '') == 'DEPUTI BIDANG SISTEM DAN TATA KELOLA' ? 'selected' : '' }}>DEPUTI BIDANG SISTEM DAN TATA KELOLA</option>
                                    <option value="DEPUTI BIDANG PEMANTAUAN DAN PENGAWASAN" {{ old('unit_kerja', $user['unit_kerja'] ?? '') == 'DEPUTI BIDANG PEMANTAUAN DAN PENGAWASAN' ? 'selected' : '' }}>DEPUTI BIDANG PEMANTAUAN DAN PENGAWASAN</option>
                                    <option value="INSPEKTORAT UTAMA" {{ old('unit_kerja', $user['unit_kerja'] ?? '') == 'INSPEKTORAT UTAMA' ? 'selected' : '' }}>INSPEKTORAT UTAMA</option>
                                    <option value="PUSAT DATA DAN SISTEM INFORMASI" {{ old('unit_kerja', $user['unit_kerja'] ?? '') == 'PUSAT DATA DAN SISTEM INFORMASI' ? 'selected' : '' }}>PUSAT DATA DAN SISTEM INFORMASI</option>
                                </select>
