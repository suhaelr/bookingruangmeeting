-- =====================================================
-- UPDATE DATABASE - SCRIPT AMAN TANPA KONFLIK
...
-- =====================================================
-- TAMBAH TABEL LARAVEL YANG DIPERLUKAN (HANYA JIKA BELUM ADA)
-- =====================================================
...
-- =====================================================
-- TAMBAH INDEXES UNTUK OPTIMASI (HANYA JIKA BELUM ADA)
-- =====================================================
...
✅ Menggunakan CREATE TABLE IF NOT EXISTS untuk tabel Laravel
...
✅ Membuat tabel Laravel yang diperlukan
✅ Memasukkan data sample yang aman dari duplicate

CARA PENGGUNAAN:
1. Pilih database yang sudah ada di phpMyAdmin
2. Jalankan script ini - akan otomatis skip kolom/tabel yang sudah ada
