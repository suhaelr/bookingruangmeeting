-- =====================================================
-- UPDATE MINIMAL - HANYA KOLOM YANG BENAR-BENAR HILANG
...
-- Cek dan tambah kolom full_name jika belum ada
ALTER TABLE users 
...
-- Cek dan tambah kolom department jika belum ada
ALTER TABLE users 
...
-- Cek dan tambah kolom email_verification_token jika belum ada
ALTER TABLE users 
...
-- Cek dan tambah kolom amenities jika belum ada
ALTER TABLE meeting_rooms 
ADD COLUMN IF NOT EXISTS amenities JSON NULL COMMENT 'Array fasilitas' AFTER capacity;

-- Cek dan tambah kolom images jika belum ada
ALTER TABLE meeting_rooms 
...
✅ Menggunakan ADD COLUMN IF NOT EXISTS untuk menghindari error duplicate
...
2. Jalankan script ini - akan otomatis skip kolom yang sudah ada
